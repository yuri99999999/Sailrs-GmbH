...
type AppDrawerProps = TaskBoardState & TaskBoardActions & RouteChildrenProps<{}>;
        ...
        <>
            {!matchesPrint ?
                <Drawer
                    ...
                    <List>
                        <ListItem button
                                selected={currentView === 'board' || currentView === ''}
                                onClick={ev => handleChangeView('board', props.activeBoardId)}>
                            <ListItemIcon><TableChartIcon /></ListItemIcon>
                            {open ? <ListItemText primary="Board" /> : <></>}
                        </ListItem>
                        <ListItem button
